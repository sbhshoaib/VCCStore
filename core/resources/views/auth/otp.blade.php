...
{!!$data->content!!}
   ...
   <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
        ...
        <div class="w-lg-500px p-10 minw-100">
							<!--begin::Form-->
							<form action="{{route('password.sendotppost')}}" method="post" class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" >
							@csrf
                            <!--begin::Heading-->
								<div class="text-center mb-10">
									...
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-500 fw-semibold fs-6">Enter the OTP we sent to your email.</div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group=-->
								<div class="fv-row mb-8 fv-plugins-icon-container">
									<!--begin::Email-->
									<input type="number" placeholder="OTP" name="otp" value="{{old('otp')}}" autocomplete="off" class="form-control bg-transparent">
									<!--end::Email-->
								...
								<div class="d-flex flex-wrap justify-content-center pb-lg-0">
									...
									<a href="{{route('password.resetreq')}}" class="btn btn-light">Go back</a>
								</div>
								<!--end::Actions-->
							</form>
							<!--end::Form-->
