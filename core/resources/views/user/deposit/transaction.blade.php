            ...
            <div class="d-flex flex-stack flex-row-fluid">
                ...
                <div class="d-flex flex-column flex-row-fluid">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-1 mb-lg-3 me-2 fs-7">
                        ...
                        <li class="breadcrumb-item text-gray-700 fw-bold lh-1">Transactions</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                ...
                <div id="kt_app_content" class="app-content">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <h3 class="w-100 mt-5" >Account transactions</h3>
                                <span class="w-100" >To see card transactions click <a href="{{url('home/cardtransaction')}}"> here</a></span>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="transaction_table">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        @if($d->success == '1')
                                        <td class="pe-0" data-order="Successful">
                                            <!--begin::Badges-->
                                        ...
                                        <td class="text-end">
                                            <span class="fw-bold">
                                                ...
                                                @if($d->g_id=='1' && $d->category=='deposit')
                                                Automatic
                                                 @elseif($d->g_id=='2' && $d->category=='deposit')
                                                 USDT
                                                @elseif($d->g_id=='1')
                                                BTC
                                                @elseif($d->g_id=='2')
