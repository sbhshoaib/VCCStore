							...
							<div class="d-flex flex-stack flex-row-fluid">
								...
								<div class="d-flex flex-column flex-row-fluid">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-1 mb-lg-3 me-2 fs-7">
										...
										<li class="breadcrumb-item text-gray-700 fw-bold lh-1">My Profile</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
										...
										<div id="kt_account_settings_profile_details" class="collapse show">
											...
											<form  method="post" action="{{ route('update.profile') }}">
												...
												<div class="card-body border-top p-9">
														...
														<div class="col-lg-8">
															...
															<div class="row">
																...
																<div class="col-lg-12 fv-row fv-plugins-icon-container">
																	<input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="{{ Auth::user()->name }}" required>
													...
													<div class="row mb-6">
														<!--begin::Label-->
														<label   class="required col-lg-4 col-form-label required fw-semibold fs-6">Email</label>
														<!--end::Label-->
														<!--begin::Col-->
														<div class="col-lg-8 fv-row fv-plugins-icon-container">
															<input type="email" value="{{ Auth::user()->email }}" name="email" style="
    background: #bfbfbfa3;
" class="form-control form-control-lg form-control-solid" placeholder="Email Address" readonly value="" required>
														<div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row fv-plugins-icon-container">
															<input type="text" name="mobile" class="form-control form-control-lg form-control-solid"  value="{{ Auth::user()->mobile }}"  placeholder="Phone Number" >
														<div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
                                                ...
                                                <div class="row mb-6">
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row fv-plugins-icon-container">
															<input type="text" name="city" class="form-control form-control-lg form-control-solid"  value="{{ Auth::user()->city }}"  placeholder="City" >
														<div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
									...
									<div class="card mb-5 mb-xl-10">
										...
										<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
											<!--begin::Card title-->
											<div class="card-title m-0">
												<h3 class="fw-bold m-0">	@if(Auth::user()->logintype=='2' && Auth::user()->passset=='0') Set Password @else Change Password  @endif </h3>
											</div>
											<!--end::Card title-->
										</div>
										<!--begin::Card header-->
...
<script>
                    // Assuming your JavaScript variable holding the value is selectedValue
var selectedValue = "{{Auth::user()->country}}"; // Example value, replace this with your actual variable

// Get all the option elements
var options = document.querySelectorAll('option');

// Loop through each option and check if the value matches the selectedValue
