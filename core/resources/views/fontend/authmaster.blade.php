...
<!-----Search, filter mobile marge------>
    ...
    @media (max-width: 767.98px){
        ...
        .searchtop.card-title {
            margin: 0.5rem 0px!important;
			width: 100%!important;
        }
        .searchtop2.card-title {
            margin: 0.5rem 0px!important;
			width: 50%!important;
        }


        .card-toolbar.flex-row-fluid.justify-content-end.gap-5.fttop{
...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
	...
	<div class="position-fixed top-10 end-0 p-3" style="z-index: 10002;top: 24px;">
    @if(session('success'))
			...
			<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: false, lg: true}" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: false, lg: '300px'}">
				...
				<div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
					...
					<div class="d-flex align-items-center d-lg-none ms-n2 me-2" title="Show sidebar menu">
						...
						<i class="ki-solid ki-abstract-14 fs-1" style="
    font-size: calc(1.31em + 1.1vw)!important;    color: #fff;
"></i>
						</div>
					</div>
					...
					<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-1 me-lg-13">
						<a href="{{url('home')}}">
							<img style="margin-left: 10px;"  alt="Logo" src="{{asset('assets/images/')}}/logo/logo.png" class="h-30px h-lg-30px theme-light-show" />
							<img style=" margin-left: 10px;"  alt="Logo" src="{{asset('assets/images/')}}/logo/logo.png" class="h-30px h-lg-30px theme-dark-show" />
						</a>
					</div>
					<!--end::Logo-->
					...
					<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
						...
						<div class="d-flex align-items-stretch" id="kt_app_header_menu_wrapper"  style="
    z-index: 1;
">
							<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_menu_wrapper'}" style="z-index: 10001;">
														...
														<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
															...
															<div class="row">
																...
																<div class="col-lg-6 mb-3">
																	...
																	<div class="menu-item p-0 m-0">
																		...
																		<a href="{{url('home/cardlist')}}" class="menu-link @if(request()->is('home/cardlist') || request()->is('home/add_card')) active @endif ">
																			...
																			<span class="d-flex flex-column">
																				<span class="fs-6 fw-bold text-gray-800">My Cards</span>
																...
																<div class="col-lg-6 mb-3">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="{{url('home/cardtransaction')}}" class="menu-link @if(request()->is('home/cardtransaction')) active @endif">
																			<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
	...
	<!--begin:Menu item-->
								...
								<div onclick="window.location.href='{{url('home/cardtransaction')}}'" class="menu-item @if(request()->is('home/cardtransaction')) here @endif  menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
									
									<!--begin:Menu link-->
									<span class="menu-link @if(!request()->is('home/cardtransaction')) border border-gray-300 border-dashed rounded  @endif  ">
									<a href="{{url('home/cardtransaction')}}">
										<span class="menu-icon">
										<i class="fs-1 @if(!request()->is('home/cardtransaction')) text-dark @endif ki-duotone ki-arrow-right-left">
												<span class="path1"></span>
												<span class="path2"></span>
										</i>
										</span>
						...
						<div class="app-navbar flex-shrink-0">
							...
							<div class="app-navbar-item" id="kt_header_user_menu_toggle">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<!--begin::Menu item-->
									<div class="menu-item px-5 my-1">
										<a href="{{ env('APP_URL') }}/home/transaction" class="menu-link px-5">Account Transaction</a>
									</div>
									<!--end::Menu item-->
...
@endif
			...
			<div id="kt_app_footer" class="app-footer d-flex flex-column flex-md-row flex-center flex-md-stack pb-3">
				...
				<div class="text-dark order-2 order-md-1">
					...
					<a href="{{url('')}}"  class="fw-bold text-hover-primary">{{$gnl->title}}</a>
				</div>
				<!--end::Copyright-->
				<!--begin::Menu-->
				...
				All Card is issued by Cardvcc.com
    ...
    <ul class="nav-container-bottom" style="margin-bottom: 0px;    padding-left: 0px;">
      ...
      <li class="nav__item @if(request()->is('home/cardlist') || request()->is('home/add_card')) active @endif">
        <a href="{{url('home/cardlist')}}" class="nav__item-link">
          ...
          <span class="nav__item-text">My Cards</span>
        </a>
      </li>
      ...
      <li class="nav__item @if(request()->is('home/cardtransaction')) active @endif">
        <a href="{{url('home/cardtransaction')}}" class="nav__item-link">
          <div class="nav__item-icon">
...
setTimeout(function() {
	...
	<!--end::Javascript-->
	<script src="//code.tidio.co/z3bvjxtmexzx0debc89g4kdbk2afv1pe.js" async></script>
</body>
<!--end::Body-->
