    ...
    <div class="tile">
        <div class="card success">
            <div class="card-header bg-info">
                ...
                <h2 style="color: #fff; text-transform: uppercase;">Withdraw Request
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($depositd as $cat)
                            <tr>
                                ...
                                @php
                                    $gateway = \App\withdrawG::find($cat->gateway);
                             ...
                             {{$gateway['name']}}
                                ...
                                <td>
                                        ...
                                        @elseif($cat->status == 2)
                                          <button class="btn btn-success etdbtn" data-toggle="modal" data-target="#dv{{$cat->id}}" data-id="{{$cat->id}}">Given</button>
                                          <button class="btn btn-danger etdbtn" data-toggle="modal" data-target="#dcl{{$cat->id}}" data-id="{{$cat->id}}">Reject</button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Given Message</h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>

                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" method="POST" action="{{route('admin.withdraw_approve', $cat->id)}}">
                                                        @csrf
                                                        <div class="modal-body">
                                    ...
                                    <div id="dcl{{$cat->id}}" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Withdraw Decline</h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>

                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" method="POST" action="{{route('admin.withdrawdecline', $cat->id)}}">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <strong>Message</strong>
