    ...
    <div class="tile">
        <div class="card success">
            <div class="card-header bg-success">
                ...
                <h2 style="color: #fff;  text-transform: uppercase;">Card Withdraw Request
                        ...
                        @foreach($subcat as $cat)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($cat->status == 2)
                                    <button class="btn btn-success etdbtn" data-toggle="modal" data-target="#dv{{$cat->id}}" data-id="{{$cat->id}}">Withdraw</button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Withdraw Confirm</h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>

                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" method="POST" action="{{route('admin.cardwithdrawapprove', $cat->id)}}">
                                                        @csrf
                                                        <div class="modal-body">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-success ">Withdrawed</button>
                                                        </div>
                                    ...
                                    <div id="dcl{{$cat->id}}" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Decline Withdraw Request </h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>

                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" method="POST" action="{{route('admin.cardwithdrawdecline', $cat->id)}}">
                                                        @csrf
                                                        <div class="modal-body">
