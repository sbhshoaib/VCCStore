...
<div class="tile">
  <div class="row">
    ...
    <div class="col-md-6">
      <a href="{{route('admin.useraddsubstracmont',$user->id)}}" class="btn btn-lg btn-block btn-primary" style="margin-bottom:10px;"> add / substruct balance  </a>
    </div>
    
       <div class="col-md-6">
      <a href="{{route('admin.adminlogintouser',$user->id)}}" target="_blank" class="btn btn-lg btn-block btn-danger" style="margin-bottom:10px;"> Login  </a>
    </div>
  </div> 
</div>
